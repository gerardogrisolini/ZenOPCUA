...
struct CreateMonitoredItemsRequest: OPCUAEncodable, Sendable {
    let header: MessageHeader
    let typeId: NodeValue = NodeValue(method: .createMonitoredItemsRequest)
...
public struct Filter: OPCUAEncodable, Sendable {
    ...
    internal var bytes: [UInt8] {
        return typeValue.bytes + encodingMask.bytes
    }
}
